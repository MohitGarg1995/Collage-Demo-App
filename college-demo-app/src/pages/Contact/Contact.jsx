  ...
  return (
    <div className="contact-page">
      <header className="height-75">
        <div className="container h-100 min-vh-100 d-flex flex-column align-items-center justify-content-center text-light">
      ...
      <div className="container my-5 d-flex justify-content-center parentDiv">
        <Form id="contact-form">
          ...
          <Button variant="danger btn-lg" type="submit" className="btnWidth">
            Submit
          </Button>
        </Form>
      </div>
